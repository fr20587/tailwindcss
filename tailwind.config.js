    ...
    theme: {
        ...
        extend: {
            ...
            typography: (theme) => ({
                DEFAULT: {
                    css: {
                        color: 'var(--ath-text-default)',
                        '[class~="lead"]': {
                            color: 'var(--ath-text-secondary)'
                        },
                        a: {
                            color: 'var(--ath-primary-500)'
                        },
                        strong: {
                            color: 'var(--ath-text-default)'
                        },
                        ...
                        'ul > li::before': {
                            backgroundColor: 'var(--ath-text-hint)'
                        },
                        hr: {
                            borderColor: 'var(--ath-border)'
                        },
                        blockquote: {
                            color: 'var(--ath-text-default)',
                            borderLeftColor: 'var(--ath-border)'
                        },
                        h1: {
                            color: 'var(--ath-text-default)'
                        },
                        ...
                        thead: {
                            color: 'var(--ath-text-default)',
                            borderBottomColor: 'var(--ath-border)'
                        },
                        'tbody tr': {
                            borderBottomColor: 'var(--ath-border)'
                        }
